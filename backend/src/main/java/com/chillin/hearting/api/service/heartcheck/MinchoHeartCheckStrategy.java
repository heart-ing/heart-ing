...
public class MinchoHeartCheckStrategy implements HeartCheckStrategy {
    ...
    public boolean isAcquirable(String userId) {
        // 민초 하트 - 파란색 하트 5개 보내기
        int blueHeartSentCnt = heartService.getUserSentHeartCnt(userId, HeartInfo.BLUE.getId());
    ...
    public ArrayList<HeartConditionData> getAcqCondition(String userId) {
        ...
        int sentHeartCnt = heartService.getUserSentHeartCnt(userId, HeartInfo.BLUE.getId());
        result.add(
